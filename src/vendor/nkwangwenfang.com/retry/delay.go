...
// DelayStrategy has no limit.  It implements a fixed
...
// ExponentialBackoffStrategy Exponential backoff.  No iteration limit, but it gets
...
// MaximumTimeStrategy Maximum time strategy.  No iteration limit.  Limit on max time.
